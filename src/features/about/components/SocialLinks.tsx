...
export const SOCIAL_LINKS = [
    { icon: Github, label: "GitHub", href: "https://github.com/Saikushal185", category: "social" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/sai-kushal-vittanala/", category: "social" },
];
