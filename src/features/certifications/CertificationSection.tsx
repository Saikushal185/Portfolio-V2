...
export const CertificationSection = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Certifications | Sai Kushal</title>
                <meta name="description" content="Industry certifications of Sai Kushal including AWS, Oracle OCI, and MongoDB credentials." />
            </Helmet>
