...
export const ContactSection = () => {
    ...
    const socials = [
        { icon: <Github className="w-5 h-5" />, label: "GitHub", href: "https://github.com/Saikushal185", color: "blue" },
        { icon: <Linkedin className="w-5 h-5" />, label: "LinkedIn", href: "https://www.linkedin.com/in/sai-kushal-vittanala/", color: "blue" },
    ];
                ...
                <div className="lg:col-span-4 grid grid-cols-1 gap-4 md:gap-6">
                    ...
                    >
                        ...
                        <div className="space-y-1 min-w-0">
                            ...
                            <p className="text-xs sm:text-sm md:text-lg font-extrabold text-gray-900 group-hover:text-blue-600 transition-colors">saikushal185@gmail.com</p>
                        </div>
                    </a>

                    <a
                        href="tel:+919121274005"
                    ...
                    >
                        ...
                        <div className="space-y-1 min-w-0">
                            ...
                            <p className="text-sm sm:text-base md:text-xl font-extrabold text-gray-900 group-hover:text-indigo-600 transition-colors break-words">+91 9121274005</p>
                        </div>
                    </a>
