...
const PrivacyPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Sai Kushal</title>
        <meta name="description" content="Privacy policy for Sai Kushal Vittanala's portfolio website." />
      </Helmet>
      <div className="home-container relative min-h-full py-12 px-4 md:px-8 max-w-5xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed">
          <section className="mb-6">
            ...
            <p className="mb-4">
              This Privacy Policy explains how Sai Kushal Vittanala ("I", "me", or "my") collects,
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-gray-500 text-center mt-8 border-t border-gray-200 pt-6">
              This Privacy Policy constitutes a legally binding agreement between you and Sai Kushal Vittanala.
