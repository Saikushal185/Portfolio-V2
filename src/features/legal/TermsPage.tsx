...
const TermsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | Sai Kushal</title>
        <meta name="description" content="Terms and conditions for Sai Kushal Vittanala's portfolio website." />
      </Helmet>
      <div className="home-container relative min-h-full py-12 px-4 md:px-8 max-w-5xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none text-gray-700 leading-relaxed">
          <section className="mb-6">
            ...
            <p className="mb-4">
              Welcome to the personal portfolio website of Sai Kushal Vittanala (the "Website").
          ...
          <section className="mb-10">
            ...
            <p className="text-sm text-gray-500 text-center mt-8 border-t border-gray-200 pt-6">
              These Terms and Conditions constitute a legally binding agreement between you and Sai Kushal Vittanala.
