...
export const SkillsSection = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Skills | Sai Kushal</title>
                <meta name="description" content="Explore Sai Kushal's technical skills in Python, Machine Learning, Data Analytics, Power BI, TensorFlow, and cloud technologies." />
            </Helmet>
