...
export const EducationSection = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Education | Sai Kushal</title>
                <meta name="description" content="Academic background of Sai Kushal Vittanala - B.Tech in Computer Science from VIT with 8.44 CGPA." />
            </Helmet>
