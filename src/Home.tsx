        ...
        <div className="home-container relative min-h-full flex flex-col items-center py-12 px-4">
            ...
            <div className="text-center space-y-6 max-w-4xl mx-auto mb-16">
                ...
                <p className="text-xl text-gray-500 font-medium max-w-2xl mx-auto leading-relaxed">
                    Data Analytics & AI/ML Specialist building intelligent systems and extracting actionable insights.
                </p>
                ...
                <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
                    ...
                    >
                        ...
                        <div className="text-center">
                            <span className="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-1">LeetCode Knight</span>
                            <span className="block text-base font-bold text-gray-900">1800+ Rating</span>
                        </div>
                    </a>
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <span className="block text-base font-bold text-gray-900">500+ Solved</span>
                        </div>
                    </a>

                    <a
                        href="https://codolio.com/profile/Sai%20Kushal"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex flex-col items-center hover:scale-105 transition-transform cursor-pointer"
                    >
